export const validatePhoneVietNam = (phoneNum?: string): boolean => {
  ...
  return /([\+84|84|0]+(3|5|7|8|9|1[2|6|8|9]))+([0-9]{8})\b/.test(phoneNum);
};
...
export const validateRegister = (data: RegisterRequest): Number => {
  if (
    ...
    validatePassRedo(data.password, data.passwordRedo)
  )
    return 2;
  if (
    validatePass(data.fullname) &&
